...
impl BufferPool {
    ...
    pub fn open(path: &Path, capacity: usize) -> inkbase_core::Result<Self> {
    ...
    pub fn get_page(&self, page_id: PageId) -> inkbase_core::Result<Page> {
    ...
    pub fn write_page(&self, page: Page) -> inkbase_core::Result<()> {
        let mut inner = self.inner.write();
    ...
    pub fn allocate_page(&self, page_type: PageType) -> inkbase_core::Result<Page> {
        let mut inner = self.inner.write();
    ...
    pub fn flush(&self) -> inkbase_core::Result<()> {
        let mut inner = self.inner.write();
        inner.flush_all()
    }
    ...
    /// or not dirty.
    pub fn flush_page(&self, page_id: PageId) -> inkbase_core::Result<()> {
        let mut inner = self.inner.write();
...
impl BufferPoolInner {
    ...
    fn read_page_from_disk(&mut self, page_id: PageId) -> inkbase_core::Result<Page> {
    ...
    fn write_header(&mut self) -> inkbase_core::Result<()> {
    ...
    fn flush_all(&mut self) -> inkbase_core::Result<()> {
    ...
    fn flush_single(&mut self, page_id: PageId) -> inkbase_core::Result<()> {
    ...
    fn evict_lru(&mut self) -> inkbase_core::Result<()> {
