...
use inkbase_core::{BlockRecord, BlockType, DocumentRecord, LinkRecord, LinkType, TagRecord};
...
pub fn parse_markdown(path: &str, content: &str) -> inkbase_core::Result<ParseResult> {
