...
async fn main() -> Result<()> {
    ...
    tracing::info!("markdotabase starting, data_dir={}", cli.data_dir.display());
    ...
    match cli.command {
        ...
        Commands::Api { bind } => {
            ...
            mdbase_api::run_server(state, &bind).await?;
            Ok(())
        }
